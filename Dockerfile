...
RUN set -xe \
    ...
    && wget "https://download.schneider-electric.com/files?p_enDocType=Firmware&p_File_Name=powernet432.mib&p_Doc_Ref=APC_POWERNETMIB_432" --content-disposition -P /usr/share/snmp/mibs \
